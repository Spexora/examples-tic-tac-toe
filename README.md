...
A tic-tac-toe game with single-player (vs. bot) and real-time multiplayer support, built with [SvelteKit](https://kit.svelte.dev/).
...
- **Singleplayer bot** – optimal minimax bot plays as O; blocks winning moves, takes winning moves, and never loses
...
- `features/bot.feature` – singleplayer bot behaviour (moves after user, blocks threats, takes wins, never loses)
...
src/
  lib/
    ...
    bot.ts                      # Minimax bot for singleplayer mode
